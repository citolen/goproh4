...
GoPro.Settings.VIDEO_EIS = 78;
GoPro.Settings.VideoEIS = {
    OFF: 0,
    ON: 1
};
...
GoPro.Settings.VIDEO_PROTUNE_ISO_MODE = 74;
GoPro.Settings.VideoProtuneIsoMode = {
    ImMax: 0,
    ImLock: 1
};

GoPro.Settings.VIDEO_AUDIO_PROTUNE = 79;
GoPro.Settings.VideoAudioProtune = {
    OFF: 0,
    ON: 1
};

GoPro.Settings.VIDEO_AUDIO_MODE = 80;
GoPro.Settings.VideoAudioMode = {
    Stereo: 0,
    Wind: 1,
    Auto: 2
};

GoPro.Settings.VIDEO_RAW_AUDIO_MODE = 81;
GoPro.Settings.VideoRawAudioMode = {
    Low: 0,
    Medium: 1,
    High: 2,
    OFF: 3
...
GoPro.Settings.VIDEO_ASPECT_RATIO = 108;
GoPro.Settings.VideoAspectRatio = {
    Ratio4by3: 0,
    Ratio16by9: 1
};

GoPro.Settings.VIDEO_TIMEWARP_SPEED = 111;
GoPro.Settings.VideoTimeWarpSpeed = {
    S2X: 7,
    S5X: 8,
    S10X: 9,
    S15X: 0,
...
GoPro.Settings.VIDEO_AUDIO_TRACK = 96;
GoPro.Settings.VideoAudioTrack = {
    OFF: 0,
    ON: 1
};

GoPro.Settings.VIDEO_SHORT_CLIP_LENGTH = 107;
GoPro.Settings.VideoShortClipLength = {
    Normal: 0,
    L15Sec: 1,
    L30Sec: 2
};

GoPro.Settings.VIDEO_SPHERICAL_CAMERA_FOV = 121;
GoPro.Settings.VideoSphericalCameraFOV = {
    HeroModeMaxSuperView: 7,
    HeroModeWide: 0,
    HeroModeLinear: 4,
    HeroModeNarrow: 6,
    HeroModeDual360: 5
...
GoPro.Settings.VIDEO_LENS_USED = 122;
GoPro.Settings.VideoLensUsed = {
    HeroMode: 0,
    DualLens: 1
};
...
GoPro.Settings.PHOTO_RAW_GPR = 82;
GoPro.Settings.PhotoRAW = {
    ON: 1,
    OFF: 0
};

GoPro.Settings.PHOTO_WDR = 77;
GoPro.Settings.PhotoWDR = {
    ON: 1,
    OFF: 0
};
...
GoPro.Settings.PHOTO_SUPER_PHOTO = 109;
GoPro.Settings.PhotoSuperPhoto = {
    OFF: 0,
    Auto: 1,
    HDROnly: 2
};
...
GoPro.Settings.BURST_PROTUNE_ISO_MIN = 76;
GoPro.Settings.BurstProtuneIsoMin = {
    Im800: 0,
    Im400: 1,
    Im200: 2,
    Im100: 3
...
GoPro.Settings.SETUP_GPS = 83;
GoPro.Settings.SetupGPS = {
    ON: 1,
    OFF: 0
};

GoPro.Settings.SETUP_VOICE_COMMAND = 86;
GoPro.Settings.SetupVoiceCommand = {
    ON: 1,
    OFF: 0
};

GoPro.Settings.SETUP_LANDSCAPE_LOCK = 112;
GoPro.Settings.SetupLandscapeLock = {
    OFF: 0,
    UP: 1,
    DOWN: 2
};

GoPro.Settings.SETUP_VIDEO_CODEC = 106;
GoPro.Settings.SetupVideoCodec = {
    H264: 0,
    H265: 1
};
